...
function redirect(name) {
    ...
    switch(name){
        case "Nike-FlyBy-Mid-2090": location.replace("/Product1");break;
        case "Nike-Downshifter-2090": location.replace("/Product2");break;
        case "Iphone12pro": location.replace("/Product3");break;
        case "GalaxyS21": location.replace("/Product4");break;
        case "UniqloMickey": location.replace("/Product5");break;
    }
